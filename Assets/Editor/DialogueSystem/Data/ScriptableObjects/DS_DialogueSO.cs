...
namespace DS.ScriptableObjects
{
    ...
    public class DS_DialogueSO : ScriptableObject
    {
        ...
        public void Initialize(string dialogueName, List<LenguageData<string>> texts, List<DS_DialogueChoiceData> choices, DS_DialogueType dialogueType, bool isStartingDialogue, List<DS_DialogueEventSO> events = null)
        {

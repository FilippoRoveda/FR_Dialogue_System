...
namespace DS.Editor.Windows.Elements
{
    ...
    public class DS_BaseNode : Node
    {
        ...
        public virtual void Initialize(string nodeName, DS_GraphView context, Vector2 spawnPosition)
        {
            ...
            Texts = LenguageUtilities.InitLenguageDataSet("Dialogue Text"); ///
            SetNodeStyle();
        ...
        public virtual void Draw()
        {
            ...
            TextField dialogueNameField = ElementsUtilities.CreateTextField(DialogueName, null, callback => OnDialogueNameChanged(callback));
            ...
            Foldout dialogueTextFoldout = ElementsUtilities.CreateFoldout("DialogueText");

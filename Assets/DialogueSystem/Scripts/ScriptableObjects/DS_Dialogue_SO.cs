...
namespace DS.ScriptableObjects
{
    ...
    public class DS_Dialogue_SO : ScriptableObject
    {
        ...
        [SerializeField] public List<DS_DialogueChoice_Data> Choices {  get; set; }
        [SerializeField] public DS_DialogueType DialogueTyoe { get; set; }
        [SerializeField] public bool IsStartingDialogue { get; set; }

        public void Initialize(string dialogueName, string text, List<DS_DialogueChoice_Data> choices, DS_DialogueType dialogueType, bool isStartingDialogue)
        {

...
namespace Game
{
    ...
    public class DialogueUIController : MonoBehaviour
    {
        ...
        public void SetupDialogue(DialogueSO dialogue) 
        {
            ...
            if(dialogue.DialogueType == DialogueType.Event)
            {
        ...
        {
            speakerName.text = startSpeaker.LinkedCharacter.Data.CompleteName;
            speakerIcon.sprite = startSpeaker.LinkedCharacter.Data.Icon;
        }
